...
## [v0.8.0](https://github.com/fujiwara/maprobe/compare/v0.7.7...v0.8.0) - 2025-06-08
- Bump github.com/fujiwara/ridge from 0.6.2 to 0.13.0 by @dependabot in https://github.com/fujiwara/maprobe/pull/93
...
- Update Go toolchain to go1.24.4 by @github-actions in https://github.com/fujiwara/maprobe/pull/110
...
- Bump golang.org/x/net from 0.36.0 to 0.38.0 by @dependabot in https://github.com/fujiwara/maprobe/pull/96
...
- Bump golang.org/x/net from 0.23.0 to 0.36.0 by @dependabot in https://github.com/fujiwara/maprobe/pull/86
...
- Bump google.golang.org/grpc from 1.57.0 to 1.57.1 by @dependabot in https://github.com/fujiwara/maprobe/pull/43
- update golang.org/x/net@v0.23.0 by @fujiwara in https://github.com/fujiwara/maprobe/pull/53
- Bump google.golang.org/protobuf from 1.31.0 to 1.33.0 by @dependabot in https://github.com/fujiwara/maprobe/pull/44
- Bump actions/setup-go from 4 to 5 by @dependabot in https://github.com/fujiwara/maprobe/pull/58
- Bump docker/login-action from 2 to 3 by @dependabot in https://github.com/fujiwara/maprobe/pull/57
- Bump docker/setup-qemu-action from 2 to 3 by @dependabot in https://github.com/fujiwara/maprobe/pull/56
- Bump docker/setup-buildx-action from 2 to 3 by @dependabot in https://github.com/fujiwara/maprobe/pull/55
...
- Bump golang.org/x/net from 0.0.0-20220127200216-cd36cc0744dd to 0.17.0 by @dependabot in https://github.com/fujiwara/maprobe/pull/30
